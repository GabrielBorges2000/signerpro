...
export function Footer() {
    return (
        <footer className="flex flex-col bg-gray-800 p-8 space-y-4">
            <div className='flex justify-between md:px-8 items-center'>
                ...
                <div className="flex flex-row gap-4">
                    <Link href="https://www.instagram.com/signerpro/">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center md:justify-evenly">
                ...
                <Link href={'https://www.codeborges.com/'} className="font-roboto font-normal text-white text-center">Desenvolvido por CODE BORGES</Link>
            </div>
        </footer>
    )
}